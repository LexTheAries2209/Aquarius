...
[Latest Release / 最新版本](https://github.com/LexTheAries2209/Aquarius/releases/latest): `v1.0.1`

Bilingual release notes / 双语发布说明：[docs/releases/v1.0.1.md](docs/releases/v1.0.1.md)
...
1. 前往 [GitHub Releases](https://github.com/LexTheAries2209/Aquarius/releases/latest) 下载 `Aquarius-v1.0.1-macOS.zip`。
2. 解压后把 `Aquarius V1.0.1.app` 放到 `Applications` 或你的本地工具目录。
3. 首次打开时，如果 macOS Gatekeeper 提示来自互联网下载的 App，请在 Finder 中右键点击 App 后选择“打开”，或在“系统设置 > 隐私与安全性”中允许打开。

V1.0.1 的中文发布说明见 [docs/releases/v1.0.1.zh-CN.md](docs/releases/v1.0.1.zh-CN.md)。
...
1. Download `Aquarius-v1.0.1-macOS.zip` from [GitHub Releases](https://github.com/LexTheAries2209/Aquarius/releases/latest).
2. Unzip it and move `Aquarius V1.0.1.app` to `Applications` or your local tools folder.
...
English release notes for V1.0.1 are available at [docs/releases/v1.0.1.en.md](docs/releases/v1.0.1.en.md).
